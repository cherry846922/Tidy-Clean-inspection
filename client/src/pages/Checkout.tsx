    ...
    <form onSubmit={handleSubmit} className="w-full max-w-md mx-auto">
      <Card className="border shadow-md">
        <CardHeader className="pb-3">
          <CardTitle className="gradient-text-primary">Complete Payment</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-6">
          <div className="border rounded-lg p-4 bg-slate-50 shadow-sm">
            ...
            <div className="flex justify-between mb-2">
              <span className="text-sm text-slate-600">Cleaner:</span>
            ...
            <div className="flex justify-between pt-2 border-t">
              ...
              <span className="text-sm font-bold gradient-text-primary">${inspection.price.toFixed(2)}</span>
            </div>
          </div>
          
          <div className="space-y-4">
            <h3 className="text-sm font-medium gradient-text-primary">Payment Details</h3>
        ...
        <CardFooter className="flex justify-between">
          ...
          >
            ...
            ) : `Pay $${inspection.price.toFixed(2)}`}
          </Button>
        </CardFooter>
      </Card>
    </form>
...
export default function Checkout() {
    ...
    return (
      <div className="p-8 max-w-md mx-auto text-center">
        <Card className="shadow-md border">
          <CardHeader className="pb-3">
            <CardTitle className="text-xl font-bold gradient-text-primary">Payment Setup Error</CardTitle>
            <CardDescription>
  ...
  return (
    <div className="py-8 px-4 max-w-4xl mx-auto">
      <h1 className="text-2xl font-bold mb-6 gradient-text-primary">Complete Your Booking</h1>
      
      <div className="gradient-bg-soft p-6 rounded-lg shadow-md">
