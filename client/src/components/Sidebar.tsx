      ...
      <div className={`sidebar bg-white shadow-lg md:w-64 fixed md:sticky top-0 h-screen z-50 md:z-0 md:flex flex-col transition-transform duration-300 transform ${isOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'} border-r border-gray-200`}>
        ...
        <nav className="flex-1 p-4">
          <ul className="space-y-2">
            ...
            {/* Only inspectors can see the Cleaners section */}
            {isInspector && (
              <li>
                <Link href="#" 
            ...
            <li>
              <Link href="/reports" 
                className={`flex items-center p-3 text-[#484848] rounded-lg font-medium ${isActive('/reports') ? 'bg-[#EBEBEB]' : 'hover:bg-gray-100'}`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-3 ${isActive('/reports') ? 'text-primary' : 'text-[#767676]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            {/* Property Optimization Page - Only for hosts */}
            {isHost && (
              <li>
            ...
            <li>
              <Link href="/animation-demo" 
                className={`flex items-center p-3 text-[#484848] rounded-lg font-medium ${isActive('/animation-demo') ? 'bg-[#EBEBEB]' : 'hover:bg-gray-100'}`}
              >
                <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 mr-3 ${isActive('/animation-demo') ? 'text-primary' : 'text-[#767676]'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
